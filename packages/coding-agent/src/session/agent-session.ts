...
import type { BranchSummaryEntry, CompactionEntry, NewSessionOptions, SessionContext } from "./types";
import type { SessionManager } from "./session-manager";
import { getLatestCompactionEntry } from "./session-manager";
import {
	getSessionStats as _getSessionStats,
	getContextUsage as _getContextUsage,
	fetchUsageReports as _fetchUsageReports,
	exportToHtml as _exportToHtml,
	getLastAssistantText as _getLastAssistantText,
	formatSessionAsText as _formatSessionAsText,
	formatCompactContext as _formatCompactContext,
} from "./session-format";
...
// Re-export for package barrel (src/index.ts → export * from "./session/agent-session")
export type {
	AgentSessionEvent,
	AgentSessionEventListener,
	AsyncJobSnapshot,
...
export class AgentSession {
	...
	getSessionStats(): SessionStats {
		return _getSessionStats(this.state, this.sessionFile, this.sessionId);
	}
	...
	getContextUsage(): ContextUsage | undefined {
		return _getContextUsage(this.model, this.messages, this.sessionManager.getBranch());
	}

	async fetchUsageReports(): Promise<UsageReport[] | null> {
		return _fetchUsageReports(this.#modelRegistry);
	}
	...
	async exportToHtml(outputPath?: string): Promise<string> {
		return _exportToHtml(this.sessionManager, this.state, outputPath);
	}
	...
	getLastAssistantText(): string | undefined {
		return _getLastAssistantText(this.messages);
	}
	...
	formatCompactContext(): string {
		return _formatCompactContext(this.messages);
	}
