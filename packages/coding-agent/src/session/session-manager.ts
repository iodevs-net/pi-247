...
import { createSessionId, generateId, migrateToCurrentVersion } from "./session-migrations";
import { buildSessionContext } from "./session-context-builder";
import { collectSessionsFromFiles, findMostRecentSession } from "./session-discovery";

export { CURRENT_SESSION_VERSION, type SessionHeader, type SessionInfo, type SessionEntry, type FileEntry, type SessionTreeNode, type SessionContext, type NewSessionOptions };

// ============================================================================
// Session types — most are in types.ts. Keep ReadonlySessionManager here
// since it references the SessionManager class.
// ============================================================================
