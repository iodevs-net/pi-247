...
import { $env, $flag, abortableSleep, logger, readSseJson, structuredCloneJSON } from "@oh-my-pi/pi-utils";
 ...
 */
export function supportsFreeformApplyPatchCodex(model: Model<"openai-codex-responses">): boolean {
